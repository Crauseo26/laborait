        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 flex flex-col space-y-6">
            ...
            <div className="flex flex-col space-y-5 text-lg text-slate-700 leading-relaxed font-medium">
              <p>
                Soy Jorge, abogado laboralista. <span className="font-bold text-slate-900 bg-emerald-100 px-1 py-0.5 rounded">Pero antes de ser abogado, fui chofer de Uber.</span>
              </p>
              <p>
              ...
              <div className="bg-slate-50 border-l-4 border-emerald-500 p-5 rounded-r-xl my-2">
                ...
                <div className="flex items-start md:items-center gap-2 text-emerald-700 mt-3">
            ...
            <div className="pt-6 border-t border-slate-100 mt-2">
              ...
              <Link 
                ...
                className="group inline-flex items-center text-lg md:text-xl font-bold text-white transition duration-300 bg-emerald-600 hover:bg-emerald-700 px-6 sm:px-8 py-4 rounded-xl shadow-md hover:shadow-lg w-full sm:w-auto justify-center"
              >
