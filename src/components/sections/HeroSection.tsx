      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-12">
          ...
          <div className="flex-1 space-y-5 md:space-y-6 text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-primary-900 leading-[1.15]">
            ...
            <div className="pt-2">
              ...
              <p className="text-sm text-neutral-500 font-medium mt-4 tracking-wide">
          ...
          <div className="flex-1 w-full max-w-[500px] lg:max-w-none">
            <div className="aspect-video lg:aspect-square w-full bg-neutral-100 rounded-2xl flex items-center justify-center border border-neutral-200 shadow-sm relative overflow-hidden">
               <span className="text-neutral-500 font-medium px-4 text-center">[LCP Image/Video Placeholder]</span>
            </div>
          </div>
        </div>
      </div>
